...
public enum MethodEnum {
    ...
    VIEW_LUCK_STATISTICAL("奇遇统计-图片服务", "/view/luck/statistical", String.class, "url", Object.class),
    DATA_LUCK_COLLECT("奇遇汇总-数据", "/data/luck/collect", LuckCollectData.class, null, List.class),
    VIEW_LUCK_COLLECT("奇遇汇总-图片服务", "/view/luck/collect", String.class, "url", Object.class),
    DATA_LUCK_SERVER_STATISTICAL("全服统计-数据", "/data/luck/server/statistical", LuckServerStatisticalData.class, null, List.class),
    VIEW_LUCK_SERVER_STATISTICAL("全服统计-图片服务", "/view/luck/server/statistical", String.class, "url", Object.class),
    DATA_MATCH_RECENT("名剑战绩-数据", "/data/match/recent", MatchRecentData.class, null, Object.class),
    VIEW_MATCH_RECENT("名剑战绩-图片服务", "/view/match/recent", String.class, "url", Object.class),
    DATA_MATCH_AWESOME("名剑排行-数据", "/data/match/awesome", MatchAwesomeData.class, null, List.class),
    VIEW_MATCH_AWESOME("名剑排行-图片服务", "/view/match/awesome", String.class, "url", Object.class),
    DATA_MATCH_SCHOOLS("名剑统计-数据", "/data/match/schools", MatchSchoolsData.class, null, List.class),
    VIEW_MATCH_SCHOOLS("名剑统计-图片服务", "/view/match/schools", String.class, "url", Object.class),
    DATA_MEMBER_RECRUIT("团队招募-数据", "/data/member/recruit", MemberRecruitData.class, null, Object.class),
    VIEW_MEMBER_RECRUIT("团队招募-图片服务", "/view/member/recruit", String.class, "url", Object.class),
    DATA_RANK_STATISTICAL("风云榜单-数据", "/data/rank/statistical", Map.class, null, List.class),
    VIEW_RANK_STATISTICAL("风云榜单-图片服务", "/view/rank/statistical", String.class, "url", Object.class),
    ...
    VIEW_SERVER_SAND("沙盘信息-图片服务", "/view/server/sand", String.class, "url", Object.class),
    DATA_SERVER_EVENT("阵营事件-数据", "/data/server/event", ServerSandData.class, null, List.class),
    VIEW_SERVER_EVENT("阵营事件-图片服务", "/view/server/event", String.class, "url", Object.class),
    DATA_TRADE_RECORD("物品价格-数据", "/data/trade/record", TradeRecordData.class, null, Object.class),
    VIEW_TRADE_RECORD("物品价格-图片服务", "/view/trade/record", String.class, "url", Object.class),
    /*纯数据接口*/
    ...
    VIEW_ACTIVE_MONSTER("百战首领-图片服务", "/view/active/monster", String.class, "url", Object.class),
    DATA_RANK_SERVER_STATISTICAL("全服榜单-数据", "/data/rank/server/statistical", Map.class, null, List.class),
    VIEW_RANK_SERVER_STATISTICAL("全服榜单-图片服务", "/view/rank/server/statistical", String.class, "url", Object.class),
    DATA_VALUABLES_STATISTICAL("掉落统计-数据", "/data/valuables/statistical", ValuablesStatisticalData.class, null, List.class),
    VIEW_VALUABLES_STATISTICAL("掉落统计-图片服务", "/view/valuables/statistical", String.class, "url", Object.class),
    ...
    VIEW_VALUABLES_SERVER_STATISTICAL("全服掉落-图片服务", "/view/valuables/server/statistical", String.class, "url", Object.class),
    DATA_VALUABLES_COLLECT("掉落汇总-数据", "/data/valuables/collect", ValuablesCollectData.class, null, List.class),
    VIEW_VALUABLES_COLLECT("掉落汇总-图片服务", "/view/valuables/collect", String.class, "url", Object.class),
    DATA_WATCH_RECORD("烟花记录-数据", "/data/watch/record", WatchRecordData.class, null, List.class),
    VIEW_WATCH_RECORD("烟花记录-图片服务", "/view/watch/record", String.class, "url", Object.class),
    DATA_WATCH_STATISTICAL("烟花统计-数据", "/data/watch/statistical", WatchStatisticalData.class, null, List.class),
    VIEW_WATCH_STATISTICAL("烟花统计-图片服务", "/view/watch/statistical", String.class, "url", Object.class),
    DATA_WATCH_COLLECT("烟花汇总-数据", "/data/watch/collect", WatchCollectData.class, null, List.class),
    VIEW_WATCH_COLLECT("烟花汇总-图片服务", "/view/watch/collect", String.class, "url", Object.class),
    /*纯数据接口*/
